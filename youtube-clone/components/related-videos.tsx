...
const RelatedVideos = ({ currentVideoId, category = "all" }: RelatedVideosProps) => {
  ...
  const allRelatedVideos: RelatedVideo[] = [
    ...
    },
    {
      ...
      channel: "NatGeo",
      channelAvatar: getAvatarUrl("NatGeo", "1ABC9C"),
      views: "1.2M views",
    ...
    },
    {
      ...
      channelAvatar: getAvatarUrl("Nextjs", "000000"),
      views: "98K views",
      timestamp: "1 day ago",
    ...
    },
    {
      ...
      channel: "CSS Tricks",
      channelAvatar: getAvatarUrl("CSS", "9B59B6"),
      views: "67K views",
    ...
    },
    {
      ...
      channelAvatar: getAvatarUrl("TS", "3178C6"),
      views: "123K views",
      timestamp: "3 days ago",
    ...
    },
    {
      ...
      channelAvatar: getAvatarUrl("TW", "06B6D4"),
      views: "78K views",
      timestamp: "1 week ago",
    ...
    },
    {
      ...
      channelAvatar: getAvatarUrl("ReactHooks", "61DAFB"),
      views: "234K views",
    ...
    },
    {
      ...
      channel: "BackendPro",
      channelAvatar: getAvatarUrl("API", "FF6B6B"),
      views: "56K views",
      timestamp: "4 days ago",
