...
const videoDatabase: SearchResult[] = [
  ...
  },
  {
    ...
    channelAvatar: getAvatarUrl("React", "61DAFB"),
  ...
  },
  {
    ...
    channel: "NextMaster",
    channelAvatar: getAvatarUrl("Next", "000000"),
  ...
  },
  {
    ...
    channelAvatar: getAvatarUrl("Data", "3498DB"),
  ...
  },
  {
    ...
    channelAvatar: getAvatarUrl("Nature", "1ABC9C"),
  ...
  },
  {
    ...
    channel: "Jazz Cafe",
    channelAvatar: getAvatarUrl("Jazz", "F39C12"),
  ...
  },
  {
    ...
    channelAvatar: getAvatarUrl("Movies", "9B59B6"),
